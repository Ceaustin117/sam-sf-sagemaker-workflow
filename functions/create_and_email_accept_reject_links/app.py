...
def lambda_handler(event, context):
    ...
    url_template_sucess = f'https://{api_id}.execute-api.us-east-2.amazonaws.com/v1/respond?type=success&{urllib.parse.urlencode({"token":{task_token}})}'
    url_template_fail = f'https://{api_id}.execute-api.us-east-2.amazonaws.com/v1/respond?type=fail&{urllib.parse.urlencode({"token":{task_token}})}'
